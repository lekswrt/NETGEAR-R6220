#ifndef PROJECT_DEFINES_R6260
#define PROJECT_DEFINES_R6260
...
#define SC_GPIO_DEFINE_R6260
//#define SC_GPIO_DEFINE_R6260_CUT1
#define SC_GPIO_DEFINE_R6260_CUT2
...
#define MTD_BLOCK_TM "/dev/mtdblock26"
#define MTD_CHAR_TM "/dev/mtd26"

#define MTD_BLOCK_TM_OLD	"/dev/mtdblock19"
#define MTD_CHAR_TM_OLD	"/dev/mtd19"
...
/* R6260: driver team sugguest new PID offset 0x3ffff to avoid potential 
 * Sercomm DL failed in production line. */
#define SC_BOOTLOADER_PID_END 0x40000 // XXX.par end of pid + 1, 3ffff+1 
/* be compatible with old device */
#define SC_BOOTLOADER_PID_END_OLD 0xf0000 // XXX.par end of pid + 1, effff+1 
...
#define PID_OFFSET_OLD      SC_BOOTLOADER_PID_END_OLD - PID_LEN // offset in mtd block effba 
...
#define SINGLESKU_SOURCE_PATH (sc_5g_max_stream == 4 ? "/etc/mtk/singlesku_r6350/" : "/etc/mtk/singlesku_r6260/")
