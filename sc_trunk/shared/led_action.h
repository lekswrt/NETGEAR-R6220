...
#elif defined (SC_GPIO_DEFINE_R6260)
#define LED_WPS_ID                  LED_WLAN_ID
#else
...
#if defined (SC_GPIO_DEFINE_RE2600M) || defined(SC_GPIO_DEFINE_RTA2600R2) || defined(SC_GPIO_DEFINE_R6260)
/* Firmware upgrading */
...
#ifdef SC_GPIO_DEFINE_R6260
#define LED_ACTION_TM_LIMIT()       do { system(LED_APP LED_BLINKALWAYS LED_WAN_GREEN_ID " 1 1000 1000 0"); } while(0)
#else
