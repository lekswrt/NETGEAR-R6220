...
#define CULR_HTTPS_UPG "curl_https_upg"
#define IMAGE_SERVER_HTTPS "http.fw.updates1.netgear.com/%s/ww/"
enum
{
	DLFILE_NONE,
	DLFILE_HTTPS,
...
int download_file(char *server,char *r_file,char *l_file, int download_method);
