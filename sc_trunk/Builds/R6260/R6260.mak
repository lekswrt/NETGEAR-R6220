...
SDK_PKG=MediaTek_APSoC_SDK5010_MT7603V4.0.1.0rev2.P1_MT7615V4412cp3ntgr0815_20170908.tgz
SDK_DIR=sdk5010
...
APCLI=1
MT_CODE=0
# R6260(3x3) and R6350(4x4) use separated MT codes for different EEPROM.
# when build R6260 MT code, set to 1, otherwise set to 0.
MT_CODE_USE_EEPROM_4_R6260=1
...
#
ENV_FILE=R6260/env.mak
MOUNT_SH_FILE=mount.sh.r6220
INITTAB_FILE=inittab.normal
DEFAULT_FILE=default.r6260
PROJECT_DEFINES_H_FILE=sc_project_defines_r6260.h
...
RC_BOARD_INIT_FILE=board_init.c_r6260
...
WIFI_5G_PALNA_TYPE=iPAiLNA
WIFI_2G_EEPROM_FILE=R6260_2G_EEPROM_20170927.bin
WIFI_5G_EEPROM_FILE=R6260_5G_EEPROM_20170927.bin
...
#
KCODES=0
KCODES_USE=kcodes_R6260
BONJOUR_USE=bonjour_R6260
...
USB=1
USE_SAMBA_ABOVE_4_6_4=1
BUILD_SAMBA_ABOVE_4_6_4_UNDER_SDK=1
SMB_4_6_4_LIBINTMP=1
USB_PRINTER=0
EXT4=1
IPMAC=0
MULTI_PVC=0
...
PNPX=1
PARAGON_NTFS=0
PARAGONNTFS_USE=paragon_ntfs_R6260
GUEST_MANAGEMENT=1
GUI_V14=1
#
#--------------NTFS 3G-------------------
...
# Need encrypt Config file
ENCRYPT_CFG=0

#Enable the default lease time is 30 minutes for DHCP clients on guest wireless network
GUEST_LEASE_TIME=0
