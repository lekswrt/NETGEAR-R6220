...
#define BUILD_SYSTEM "Linux localhost.localdomain 2.6.31.5-127.fc12.i686.PAE #1 SMP Sat Nov 7 21:25:57 EST 2009 i686 i686 i386 GNU/Linux"
#define HAVE_SYS_UTSNAME_H 1
#define SYSTEM_UNAME_SYSNAME "Linux"
#define SYSTEM_UNAME_MACHINE "mips"
#define SYSTEM_UNAME_RELEASE "2.6.36"
#define SYSTEM_UNAME_VERSION "# SMP #"
...
/* #undef HAVE_GSS_IMPORT_CRED */
/* #undef HAVE_GSS_EXPORT_CRED */
/* #undef HAVE_GSS_ACQUIRE_CRED_FROM */
/* #undef HAVE_GSS_KRB5_CRED_NO_CI_FLAGS_X */
#define HAVE_KRB5_MK_REQ_EXTENDED 1
/* #undef HAVE_KRB5_KT_COMPARE */
#define HAVE_KRB5_AUTH_CON_GETRECVSUBKEY 1
...
/* #undef HAVE_KRB5_GET_INIT_CREDS_KEYBLOCK */
...
#define HAVE_KRB5_CC_COPY_CREDS 1
#define HAVE_KRB5_FREE_CHECKSUM_CONTENTS 1
#define HAVE_KRB5_C_MAKE_CHECKSUM 1
/* #undef HAVE_KRB5_CREATE_CHECKSUM */
/* #undef HAVE_KRB5_CONFIG_GET_BOOL_DEFAULT */
#define HAVE_KRB5_GET_PROFILE 1
/* #undef HAVE_KRB5_DATA_COPY */
#define HAVE_KRB5_INIT_KEYBLOCK 1
/* #undef HAVE_KRB5_PRINCIPAL_SET_REALM */
/* #undef HAVE_KRB5_PRINCIPAL_GET_TYPE */
/* #undef HAVE_KRB5_PRINCIPAL_SET_TYPE */
/* #undef HAVE_KRB5_WARNX */
...
/* #undef _HAVE_ENCTYPE_ARCFOUR_HMAC_MD5 */
/* #undef _HAVE_ENCTYPE_ARCFOUR_HMAC_MD5_56 */
/* #undef _HAVE_KEYTYPE_ARCFOUR_56 */
#define HAVE_ENCTYPE_ARCFOUR_HMAC 1
#define HAVE_ENCTYPE_ARCFOUR_HMAC_EXP 1
...
/* #undef HAVE_LSEEK_HOLE_DATA */
#define HAVE_LINUX_READAHEAD 1
#define HAVE_DECL_READAHEAD 1
#define HAVE_OPENAT 1
/* #undef HAVE_IO_SUBMIT */
/* #undef HAVE_LINUX_KERNEL_AIO */
...
/* #undef HAVE_ENDNETGRENT_PROTOTYPE */
...
/* #undef _HAVE_UNBROKEN_POSIX_FALLOCATE */
...
#define HAVE_FTW_H 1
/* #undef HAVE_NFTW */
/* #undef HAVE_DES_PCBC_ENCRYPT */
#define STRING_STATIC_MODULES "vfs_default auth_domain auth_builtin auth_sam auth_winbind pdb_smbpasswd pdb_tdbsam pdb_wbc_sam auth_unix auth_wbc nss_info_template idmap_tdb idmap_passdb idmap_nss"
...
#define static_decl_auth extern NTSTATUS auth_domain_init(void); extern NTSTATUS auth_builtin_init(void); extern NTSTATUS auth_sam_init(void); extern NTSTATUS auth_winbind_init(void); extern NTSTATUS auth_unix_init(void); extern NTSTATUS auth_wbc_init(void);
#define static_init_auth { auth_domain_init();  auth_builtin_init();  auth_sam_init();  auth_winbind_init();  auth_unix_init();  auth_wbc_init(); }
...
#define static_decl_rpc 
#define static_init_rpc {}
#define HAVE_PTY_H 1
