...
/* define if the system header files are missing prototype for isblank() */
/* #undef NEED_ISBLANK_PROTO */
...
#define PACKAGE_STRING "Kerberos 5 1.9"
...
/* Create a special build to test Fortuna PRNG */
/* #undef TEST_FORTUNA */
